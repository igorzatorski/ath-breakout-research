...
def normalize_crsp_daily(raw_data: pd.DataFrame) -> pd.DataFrame:
    ...
    data = data.rename(
        columns={
            ...
            "dlyreti": "income_return",
            "dlyretmissflg": "return_missing_flag",
            "dlyretdurflg": "return_duration_flag",
            "dlyorddivamt": "ordinary_dividend",
            "dlynonorddivamt": "nonordinary_dividend",
            "dlyfacprc": "period_price_factor",
            "dlydistretflg": "distribution_return_flag",
